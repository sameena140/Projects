...
main = tkinter.Tk()
main.title("Forensic analysis of fingerprint image detection using deep learning algorithm") #designing main screen
...
def generateModel():
  global classifier
  text.delete('1.0', END)
  text.insert(END,"Generating model...")
...
def predict():
    ...
    if predict == 0:
        ...
        cv2.putText(img, 'not-criminal', (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.6, (0, 255, 255), 2)
        msg = 'not-criminal'
...
font = ('times', 16, 'bold')
title = Label(main, text='Forensic analysis of fingerprint image detection using deep learning algorithm', justify=LEFT)
