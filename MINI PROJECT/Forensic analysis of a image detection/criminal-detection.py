...
main = tkinter.Tk()
main.title("Forensic analysis of a image detection") #designing main screen
...
def predict():
    ...
    if predict == 0:
        ...
        cv2.putText(img, 'non-criminal', (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.6, (0, 255, 255), 2)
        msg = 'non-criminal'
...
font = ('times', 16, 'bold')
title = Label(main, text='Forensic analysis of a image detection for Crime Detectione', justify=LEFT)
